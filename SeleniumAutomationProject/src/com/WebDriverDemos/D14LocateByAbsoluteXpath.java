...
public class D14LocateByAbsoluteXpath {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/div/div/div/div/div/div/div[2]/div/div/form/div/div/input")).sendKeys("poonamtest@gmail.com");
